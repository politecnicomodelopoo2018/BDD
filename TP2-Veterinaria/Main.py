            ...
            if opcion_consultas == "1":
                ...
                while(loop):
                    ...
                    if opcion_select_consultas == "1":
                        ...
                        consulta = Consulta.SelectMascotaporID(consulta_a_seleccionar)
                        print(str(consulta.id), consulta.precio, consulta.diagnostico, item.mascota.id, item.veterinario.id)
